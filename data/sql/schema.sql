CREATE TABLE product (id BIGINT AUTO_INCREMENT, product_category_id BIGINT, product_line_id BIGINT, name VARCHAR(255) NOT NULL, description_short TEXT NOT NULL, description_long TEXT NOT NULL, price VARCHAR(255), image VARCHAR(255), INDEX product_category_id_idx (product_category_id), INDEX product_line_id_idx (product_line_id), PRIMARY KEY(id)) ENGINE = INNODB;
